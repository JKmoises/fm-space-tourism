...
export function Crew(crews = []) {
  ...
  $slidesNav.classList.add('absolute','top-64','sm:top-48','lg:top-auto','lg:bottom-20', 'flex', 'justify-center', 'gap-4', 'w-full','lg:w-auto');
  ...
  crews.forEach((_, i) => {
    ...
    $slidesDot.classList.add('inline-block','bg-white/20','w-3','h-3','rounded-full','cursor-pointer');
