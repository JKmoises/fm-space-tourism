...
export function Slide(crew) {
  ...
  $slideImage.innerHTML = /*html*/ `
    <picture>
      ...
      <img class="lg:w-4/5 mx-auto h-full lg:h-auto object-cover" src="${PATH_IMAGE}/${images.png}" alt="${name}" loading="lazy" />
    </picture>
  `;
